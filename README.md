...
Get your API token from Hugging Face Tokens.
When running the Streamlit app, enter the API token in the provided input field.
Or, store it in Streamlit secrets by adding to .streamlit/secrets.toml:
[secrets]
...
“This project is inspired by and extended from open-source RAG implementations. Customizations and improvements were made for learning and practical usage.”
